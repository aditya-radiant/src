...
def walk():
    ...
    for t in T:
        ...
        if (0 <= t < dsp_1_end):
            x = walkSin(t, dsp_ratio * step_periode, 0, swap_distance/2, swap_distance/2)
        ...
        if (dsp_1_end <= t < ssp_1_end):
            z = walkSin(t, ssp_ratio * step_periode, dsp_1_end, walk_distance/2, walk_distance/2)
        ...
        if (ssp_1_end <= t < dsp_2_end):
            x = walkSin(t, dsp_ratio * step_periode, ssp_1_end, swap_distance/2, swap_distance/2)
            dataPub.right_leg.x = -x
            dataPub.right_leg.z = 26.0
            dataPub.left_leg.x = x
            dataPub.left_leg.z = 26.0
        ...
        if (dsp_2_end <= t <= ssp_2_end):
            z = walkSin(t, ssp_ratio * step_periode, dsp_2_end, walk_distance/2, walk_distance/2)
...
def setWalkParamHandler(data):
    ...
    dsp_1_end = r_dsp_start + dsp_ratio * step_periode
    ssp_1_end = dsp_1_end + ssp_ratio * step_periode
    dsp_2_end = ssp_1_end + dsp_ratio * step_periode
    ssp_2_end = dsp_2_end + ssp_ratio * step_periode
